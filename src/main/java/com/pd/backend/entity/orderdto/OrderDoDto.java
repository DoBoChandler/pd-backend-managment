 ...
 */
@Data
public class OrderDoDto {
    /**
     * id
     */
    private String id;
    private String orderCargoDtos;
   ...
   //private String receiverCountyId;
     ...
     * 省份信息
     */
    private ProvinceDto receiverProvince;

    private ProvinceDto receiverCity;
    private ProvinceDto receiverCounty;
    ...
    private ProvinceDto senderProvince;
    private ProvinceDto senderCity;
    private ProvinceDto senderCountry;
    /**
     * 订单当前所属网点
     */
